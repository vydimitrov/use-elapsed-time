...
describe('useElapsedTime', () => {
  ...
  it('should call onComplete when duration is reached', () => {
    ...
    addFrame()
    expect(result.current.elapsedTime).toBe(durationMilliseconds)
  ...
  it('should reset elapsed time to the startAt value if reset is fired', () => {
    const isPlaying = true
    const startAt = 250
    const durationMilliseconds = 1000
    const config = { durationMilliseconds, startAt }
